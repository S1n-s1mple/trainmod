...
public class CapibaraAnimation {
    ...
    public static final Animation ANIM_CAPIBARA_IDLE = Animation.Builder.create(1.5F).looping()
    ...
    public static final Animation ANIM_CAPIBARA_WALK = Animation.Builder.create(1.0F).looping()
	    .addBoneAnimation("Capibara", new Transformation(Transformation.Targets.MOVE_ORIGIN,
		    new Keyframe(0.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC),
    ...
    public static final Animation ANIM_CAPIBARA_ATTACK = Animation.Builder.create(0.5F)
