...
/**
 * A simple {@code SidedInventory} implementation with only default methods + an
 * item list getter.
 *
 * <h2>Reading and writing to tags</h2>
 * Use
 * {@link Inventories#writeNbt(NbtCompound, DefaultedList, RegistryWrapper.WrapperLookup)}
 * and
...
public interface ImplementedInventory extends SidedInventory {
     ...
     *
     * <p>
     * (default implementation) If there are less items in the slot than what
     * are requested, takes all items in that slot.
     *
     * @param slot the slot
     ...
     * {@link Inventories#removeStack(List, int)}
     *
     * @param slot the slot
     ...
     * ({@link Inventory#getMaxCountPerStack()}), it gets resized to this
