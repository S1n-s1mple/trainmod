...
public class ModEntities {
    ...
    private static final RegistryKey<EntityType<?>> CHAIR_KEY = RegistryKey.of(RegistryKeys.ENTITY_TYPE, createIdentifier("chair_entity"));
    ...
    public static final EntityType<ChairEntity> CHAIR = Registry.register(Registries.ENTITY_TYPE, createIdentifier("chair_entity"),
	    EntityType.Builder.create(ChairEntity::new, SpawnGroup.CREATURE).dimensions(0.5f, 0.5f).build(CHAIR_KEY));
