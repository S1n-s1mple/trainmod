...
public class SpiderLegs extends StatusEffect {

    public SpiderLegs(StatusEffectCategory category, int color) {
    ...
    @Override
    public boolean canApplyUpdateEffect(int dutration, int amplifier) {
	return true;
    }
